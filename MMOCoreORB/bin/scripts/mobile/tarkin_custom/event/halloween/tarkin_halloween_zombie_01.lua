tarkin_halloween_zombie_01 = Creature:new {
	customName = "a deranged zombie",
...
CreatureTemplates:addCreatureTemplate(tarkin_halloween_zombie_01, "tarkin_halloween_zombie_01")
