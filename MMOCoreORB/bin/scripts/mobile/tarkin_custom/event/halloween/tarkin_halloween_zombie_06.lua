tarkin_halloween_zombie_06 = Creature:new {
	customName = "a berzerk zombie",
...
CreatureTemplates:addCreatureTemplate(tarkin_halloween_zombie_06, "tarkin_halloween_zombie_06")
