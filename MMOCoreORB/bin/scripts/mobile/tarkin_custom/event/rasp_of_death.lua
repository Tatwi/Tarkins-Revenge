rasp_of_death = Creature:new {
	customName = "a mutant rasp",
	socialGroup = "mutant_rasp",
	faction = "",
	level = 35,
	chanceHit = 0.41,
	damageMin = 320,
	...
	templates = {"object/mobile/horned_rasp_hue.iff",
	             "object/mobile/flite_rasp_hue.iff",
		     "object/mobile/crowned_rasp_hue.iff"},
	hues = { 7, 13, 16, 26, 35, 43, 48, 57, 64, 75, 48, 52, 57, 63, 89, 95},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(rasp_of_death, "rasp_of_death")
