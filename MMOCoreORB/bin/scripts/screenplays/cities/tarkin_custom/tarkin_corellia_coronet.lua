TarkinCorelliaCoronetScreenPlay = CityScreenPlay:new {
	numberOfActs = 1,

	screenplayName = "TarkinCorelliaCoronetScreenPlay",
...
registerScreenPlay("TarkinCorelliaCoronetScreenPlay", true)

function TarkinCorelliaCoronetScreenPlay:start()
...
function TarkinCorelliaCoronetScreenPlay:spawnMobiles()
	...
	pNpc = spawnMobile(self.planet, "noble",60,-305.181,28,-4657.96,-175,0)
	--self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "rikkh",60,-250.151,28,-4695.66,8,0)
	spawnMobile(self.planet, "rhea",60,-285.681,28,-4696.56,21,0)
	...
	--self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "businessman",60,-345.119,28,-4443.98,12,0)
	--self:setMoodString(pNpc, "conversation")
	...
	--self:setMoodString(pNpc, "calm")
	spawnMobile(self.planet, "businessman",60,-338.075,28,-4445.51,10,0)
	spawnMobile(self.planet, "rebel_recruiter",60,-326.355,28,-4439.98,-140,0)
	...
	spawnMobile(self.planet, "junk_dealer", 0, -239.025, 28, -4326.28, 87, 0)
	...
	spawnMobile(self.planet, "trainer_doctor",0,-88.478,28,-4467.01,-171,0)
	...
	--spawnMobile(self.planet, "trainer_merchant",0,6.44053,28,-4452.96,-93,0)
	--spawnMobile(self.planet, "trainer_weaponsmith",0,-2.5,1.13306,-8.4,91,1855527)

	--Capitol
	pNpc = spawnMobile(self.planet, "noble",60,-176.716,28,-4503.65,-23,0)
	--self:setMoodString(pNpc, "conversation")
	...
	--self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "noble",60,-188.513,28,-4506.3,29,0)
	--self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "scientist",60,-238.123,28,-4481.99,140,0)
	--self:setMoodString(pNpc, "conversation")
	...
	--self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "businessman",60,-225.351,28,-4481.97,-152,0)
	--self:setMoodString(pNpc, "conversation")
	...
	--self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "businessman",60,-183.078,28.5996,-4136.38,98,0)
	--self:setMoodString(pNpc, "conversation")
	...
	--self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "scientist",60,-188.357,28.5996,-4122.99,82,0)
	--self:setMoodString(pNpc, "conversation")
	--pNpc = spawnMobile(self.planet, "twilek_slave",60,-25.4,0.6,10.6,130,2365393)
	--self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "noble",60,-230.396,28.5986,-4133.76,-84,0)
	...
	--self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile(self.planet, "contractor",60,-246.062,28,-4107.19,88,0)
	--self:setMoodString(pNpc, "conversation")
	...
	spawnMobile(self.planet, "theater_manager",0,-228,28.6,-4118,0,0)
	...
	spawnMobile(self.planet, "businessman",60,-129.703,28,-4779.59,-98,0)
	...
	pNpc = spawnMobile(self.planet, "commoner", 60, -55.6601, 28, -4630.65, 174, 0)
	self:setMoodString(pNpc, "calm")
	self:setCustomName(pNpc, "Hunter Javeezo")

	--More Misc
	spawnMobile(self.planet, "gadget_specialist",60,-22.9877,28,-4822.7,-48,0)
	...
	spawnMobile(self.planet, "informant_npc_lvl_1",0,-256.716,28,-4409.31,168,0)
	...
	spawnMobile(self.planet, "junk_dealer", 0, -127.12, 28, -4788.35, 82, 0)
	...
	pNpc = spawnMobile(self.planet, "junk_dealer", 0, -363.841, 28, -4442.31, -5, 0)
	if pNpc ~= nil then
	...
	spawnMobile(self.planet, "trainer_brawler",0,-177.058,28,-4714.09,-177,0)
	...
	spawnMobile(self.planet, "trainer_marksman",0,-187.293,28,-4694.3,85,0)
	...
	spawnMobile(self.planet, "trainer_merchant",0,-369,28,-4533,-89,0)
