TarkinNabooTheedScreenPlay = CityScreenPlay:new {
	numberOfActs = 1,

	screenplayName = "TarkinNabooTheedScreenPlay",
...
registerScreenPlay("TarkinNabooTheedScreenPlay", true)

function TarkinNabooTheedScreenPlay:start()
...
function TarkinNabooTheedScreenPlay:spawnSceneObjects()
...
function TarkinNabooTheedScreenPlay:spawnMobiles()
	...
	--Med Center
	spawnMobile(self.planet, "trainer_combatmedic",0,-5007.12,6,4119.88,-166,0)
	...
	pNpc = spawnMobile(self.planet, "businessman",300,-5461.38,6,4298,145,0)
	self:setMoodString(pNpc, "happy")
	pNpc = spawnMobile(self.planet, "contractor",300,-5456.15,6,4291.21,-21,0)
	...
	spawnMobile(self.planet, "junk_dealer", 0, -5475.61, 6, 4151.52, -16, 0)
	...
	--Cantina
	pNpc = spawnMobile(self.planet, "junk_dealer", 0, -5165.47, 6, 4221.06, 1, 0)
	if pNpc ~= nil then
		AiAgent(pNpc):setConvoTemplate("junkDealerArmsConvoTemplate")
	end

	--Hotel
	pNpc = spawnMobile(self.planet, "businessman",60,-5679.31,6,4526.61,30,0)
	self:setMoodString(pNpc, "worried")
	pNpc = spawnMobile(self.planet, "businessman",60,-5700.98,6,4318.41,117,0)
	--self:setMoodString(pNpc, "conversation")
	...
	--self:setMoodString(pNpc, "nervous")
	pNpc = spawnMobile(self.planet, "noble",300,-5694.21,6,4251.93,-57,0)
	--self:setMoodString(pNpc, "conversation")
	...
	pNpc = spawnMobile(self.planet, "noble",300,-5740.17,6,4247.41,4,0)
	--self:setMoodString(pNpc, "conversation")
