object_tangible_tarkin_custom_statted_gcw_reward_food_imperial = object_tangible_tarkin_custom_statted_shared_gcw_reward_food_imperial:new {
	templateType = CONSUMABLE,

	factionRestriction = "Imperial",
...
ObjectTemplates:addTemplate(object_tangible_tarkin_custom_statted_gcw_reward_food_imperial, "object/tangible/tarkin_custom/statted/gcw_reward_food_imperial.iff")
