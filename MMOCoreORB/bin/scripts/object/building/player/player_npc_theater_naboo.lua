...
object_building_player_player_npc_theater_naboo = object_building_player_shared_player_npc_theater_naboo:new {
	lotSize = 10,
...
ObjectTemplates:addTemplate(object_building_player_player_npc_theater_naboo, "object/building/player/player_npc_theater_naboo.iff")
