...
object_building_player_player_npc_university_corellia = object_building_player_shared_player_npc_university_corellia:new {
	lotSize = 5,
	...
	shopSigns = {
		...
		{templateFile = "object/tangible/sign/player/wod_sm_banner_sign_01.iff", x = 5.97474, z = 4.15, y = 19.3831, ox = 0, oy = 0.707107, oz = 0, ow =  0.707107, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:wod_sign_banner_01"},
		{templateFile = "object/tangible/sign/player/wod_sm_banner_sign_02.iff", x = 5.97474, z = 4.15, y = 19.3831, ox = 0, oy = 0.707107, oz = 0, ow =  0.707107, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:wod_sign_banner_02"},
		{templateFile = "object/tangible/sign/player/wod_sm_banner_sign_03.iff", x = 5.97474, z = 4.15, y = 19.3831, ox = 0, oy = 0.707107, oz = 0, ow =  0.707107, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:wod_sign_banner_03"},
	},
...
ObjectTemplates:addTemplate(object_building_player_player_npc_university_corellia, "object/building/player/player_npc_university_corellia.iff")
