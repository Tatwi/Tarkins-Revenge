...
object_building_player_player_npc_combat_guildhall_corellia = object_building_player_shared_player_npc_combat_guildhall_corellia:new {
	lotSize = 5,
...
ObjectTemplates:addTemplate(object_building_player_player_npc_combat_guildhall_corellia, "object/building/player/player_npc_combat_guildhall_corellia.iff")
