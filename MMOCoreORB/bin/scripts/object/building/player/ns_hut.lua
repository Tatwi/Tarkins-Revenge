...
object_building_player_ns_hut = object_building_player_shared_ns_hut:new {
	lotSize = 2,
	...
	childObjects = {
		...
		{templateFile = "object/tangible/terminal/terminal_player_structure.iff", x = 1.9677, z = 0.752993, y = 2.42718, ow = 0, ox = 0, oz = 0, oy = -1, cellid = 1, containmentType = -1},
	},
	shopSigns = {
		...
		{templateFile = "object/tangible/sign/player/wod_sm_hanging_sign_01.iff", x = 1.34373, z = 5.01, y = 5.31135, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:wod_sign_hanging"},
		...
		{templateFile = "object/tangible/tarkin_custom/decorative/mun_kash_signpost_primitive_pointer_small_s01.iff", x = -1.52834, z = 1.39, y = 5.75817, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:mun_kash_signpost_primitive_pointer_small_s01"},
		{templateFile = "object/tangible/tarkin_custom/decorative/mun_kash_signpost_refined_pointer_small_s01.iff", x = -1.52946, z = 1.39, y = 5.71819, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:mun_kash_signpost_refined_pointer_small_s01"},
		{templateFile = "object/tangible/sign/player/efol_hanging_sign_01.iff", x = -1.52834, z = 2.89, y = 5.75817, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:efol_sign_hanging"},
		...
		{templateFile = "object/tangible/sign/player/house_address_halloween_sign.iff", x = -1.53478, z = 3.89, y = 6.25813, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@static_item_n:item_special_sign_halloween_hanging_sign"},
...
ObjectTemplates:addTemplate(object_building_player_ns_hut, "object/building/player/ns_hut.iff")
