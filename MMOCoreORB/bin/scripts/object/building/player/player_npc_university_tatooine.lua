...
object_building_player_player_npc_university_tatooine = object_building_player_shared_player_npc_university_tatooine:new {
	lotSize = 5,
...
ObjectTemplates:addTemplate(object_building_player_player_npc_university_tatooine, "object/building/player/player_npc_university_tatooine.iff")
